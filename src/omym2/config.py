...
WEB_HISTORY_ROUTE: Final = "/history"  # local Web UI Run history path
WEB_RUN_DETAIL_ROUTE: Final = "/history/{run_id}"  # local Web UI Run detail path
WEB_CHECK_ROUTE: Final = "/check"  # local Web UI consistency check path
WEB_TRACKS_ROUTE: Final = "/tracks"  # local Web UI Track listing path
...
WEB_HISTORY_TEMPLATE_NAME: Final = "history.html"  # Jinja template for the Run history screen
WEB_RUN_DETAIL_TEMPLATE_NAME: Final = "run_detail.html"  # Jinja template for the Run detail screen
WEB_CHECK_TEMPLATE_NAME: Final = "check.html"  # Jinja template for the consistency check screen
WEB_TRACKS_TEMPLATE_NAME: Final = "tracks.html"  # Jinja template for the Track listing screen

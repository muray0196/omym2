...
WEB_ASSETS_ROUTE: Final = "/assets"  # local Web UI built asset mount path
...
WEB_REACT_STATIC_DIRECTORY_NAME: Final = "static_dist"  # package directory for built React assets
WEB_REACT_ASSETS_DIRECTORY_NAME: Final = "assets"  # Vite assets directory under the React build
WEB_REACT_INDEX_FILE_NAME: Final = "index.html"  # React SPA entry document
WEB_REACT_BUILD_MISSING_MESSAGE: Final = "React Web UI build is unavailable."  # missing SPA build response text

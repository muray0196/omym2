/**
 * Summary: Centralizes product-default-language copy for the Command Center.
 * Why: Keeps palette instructions and accessible names consistent across states.
 */
export const commandCenterCopy = {

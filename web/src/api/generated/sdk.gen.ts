...
/**
 * Save Artist Name Mappings
 */
export const saveArtistNameMappings = <ThrowOnError extends boolean = false>(options: Options<SaveArtistNameMappingsData, ThrowOnError>): RequestResult<SaveArtistNameMappingsResponses, SaveArtistNameMappingsErrors, ThrowOnError> => (options.client ?? client).put<SaveArtistNameMappingsResponses, SaveArtistNameMappingsErrors, ThrowOnError>({

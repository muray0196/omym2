...
export function tracksInfiniteQuery(
  ...
  return infiniteQueryOptions({
    ...
    queryFn: ({ pageParam, signal }) =>
      readTracksPage(libraryId, filters, pageParam, signal),
    queryKey: [
      "tracks",
      libraryId ?? null,
      filters.query,
...
export function trackFacetsQuery(
  ...
  return queryOptions({
    enabled: libraryId !== undefined,
    queryFn: ({ signal }) => readTrackFacets(libraryId, filters, signal),
...
export function trackGroupsInfiniteQuery(
  ...
  return infiniteQueryOptions({
    ...
    getNextPageParam: (lastPage: TrackGroupsData) =>
      lastPage.page.next_cursor ?? undefined,
    queryFn: ({ pageParam, signal }) =>
      readTrackGroups(libraryId, filters, pageParam, signal),
    queryKey: [
      "tracks",
      libraryId ?? null,
      "groups",
...
export function trackDetailQuery(trackId: string) {
  return queryOptions({
    ...
    queryFn: ({ signal }) => readTrack(trackId, signal),

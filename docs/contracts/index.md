...
* [Config Contract](config.md) - Complete TOML schema, defaults, validation, revision-safe save and Web autosave protocols, path policy, and runtime controls.
* [DB Schema Contract](db-schema.md) - SQLite tables, constraints, migration history, persisted provenance, and JSON and timestamp policy.
...
* [Web API Contract](web-api.md) - Authoritative local HTTP API contract — envelopes, CSRF, idempotency, browsing, Settings autosave and provenance, and every /api endpoint.

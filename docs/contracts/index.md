...
* [DB Schema Contract](db-schema.md) - Defines OMYM2's SQLite tables, clean baseline migration, reset policy, indexes, constraints, JSON, timestamps, and persisted companion and unprocessed evidence.

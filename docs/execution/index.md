...
* [Undo Execution](undo.md) - Defines per-Run undo, tracing succeeded FileEvents in reverse to build an undo Plan, restore-destination conflict handling, and Track removal behavior when restoring imported files to external paths.

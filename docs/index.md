...
* [Development Harness](DEVELOPMENT.md) - Specifies dependency setup, developer quality gates, checks.sh, pipeline benchmark modes, suppression rules, and Python runtime configuration policy.

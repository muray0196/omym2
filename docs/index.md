...
* [Storage](STORAGE.md) - Defines the TOML-vs-SQLite boundary, repository and Track stat-baseline responsibilities, SQLite durability rules, reproducibility, and Library-relative path policy.
* [Development Harness](DEVELOPMENT.md) - Specifies developer quality gates, checks.sh, the full-hash and trust-stat pipeline benchmark modes, suppression rules, and Python runtime configuration policy.

...
* [Development Harness](DEVELOPMENT.md) - Specifies developer quality commands for edit-loop and final validation gates (ruff, basedpyright, npm lint/build, pytest), the checks.sh wrapper, local LLM helper scripts, suppression rules, and Python runtime configuration policy.

...
* [Domain](DOMAIN.md) - Defines OMYM2's core entities, including raw track metadata, artist-name projection, durable Operations, Track stat baselines, snapshot boundaries, and UUIDv7 identity policy.

...
* [Development Harness](DEVELOPMENT.md) - Specifies developer quality commands, the checks.sh wrapper, docs search and model-assisted routing scripts, local model policy, suppression rules, and Python runtime configuration policy.

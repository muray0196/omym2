...
* [Domain](DOMAIN.md) - Defines OMYM2's core domain entities (AppConfig, FileScanEntry, FileSnapshot, TrackMetadata, PathPolicy, Library, Track, Plan, PlanAction, Run, FileEvent, CheckIssue, CheckRun), their invariants, and the UUIDv7-based ID design policy.
...
* [Development Harness](DEVELOPMENT.md) - Specifies developer quality commands for edit-loop and final validation gates (ruff, basedpyright, npm lint/build, pytest), the checks.sh wrapper, suppression rules, and Python runtime configuration policy.

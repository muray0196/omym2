...
* [Development Harness](DEVELOPMENT.md) - Specifies developer quality commands for edit-loop and final validation gates (ruff, basedpyright, npm audit/lint/build, packaged Web export audit, pytest), the checks.sh wrapper, suppression rules, and Python runtime configuration policy.

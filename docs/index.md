...
* [Development Harness](DEVELOPMENT.md) - Specifies dependency setup, current quality gates, release verification, checks.sh, suppressions, and Python runtime configuration policy.

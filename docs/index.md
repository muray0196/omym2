...
* [Development Harness](DEVELOPMENT.md) - Specifies developer quality commands for edit-loop and final validation gates (ruff, basedpyright, npm lint/build, pytest), suppression rules, and Python runtime configuration policy.

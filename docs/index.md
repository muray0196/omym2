...
* [Product](PRODUCT.md) - Describes OMYM2's product shape as a headless domain core with a CLI runner and a local Web UI for settings, Plan creation and review, and status; defines its primary safe-import use case and technology stack.

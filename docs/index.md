...
* [Development Harness](DEVELOPMENT.md) - Specifies developer quality commands, the checks.sh wrapper, docs search and routing scripts, local LLM helpers, suppression rules, and Python runtime configuration policy.

...
* [Ports And UnitOfWork](ports-uow.md) - Defines OMYM2's ports and UnitOfWork contract, including accepted artist-name persistence, durable Operations, Config revision CAS, atomic Apply claims, filesystem mutation preconditions, and FileEvent transaction ordering.

...
* [Ports And UnitOfWork](ports-uow.md) - Defines OMYM2's ports and UnitOfWork contract, including artist-name resolution and cache transactions, durable Operations, Config revision CAS, atomic Apply claims, filesystem mutation preconditions, and FileEvent transaction ordering.
...
* [Web Frontend](web-frontend.md) - Defines the bundled desktop React and Vite Web frontend contract, including routes, artist-name settings, design rules, API boundaries, browser and native-window serving, packaging, security, and performance gates.

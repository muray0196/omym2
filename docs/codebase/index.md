...
* [Source Layout](source-layout.md) - Defines OMYM2's feature-oriented source layout, including Bootstrap, durable Operation, desktop-shell placement, dependency layers, composition, and directory rules.
...
* [Web Frontend](web-frontend.md) - Defines the bundled desktop React and Vite Web frontend contract, including routes, design rules, API boundaries, browser and native-window serving, packaging, security, and performance gates.

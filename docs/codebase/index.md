...
* [Ports And UnitOfWork](ports-uow.md) - Defines OMYM2's ports and UnitOfWork contract, including editable artist-name mappings, provider cadence transactions, durable Operations, Config revision CAS, atomic Apply claims, cross-platform retained-object mutation preconditions, and FileEvent ordering.
